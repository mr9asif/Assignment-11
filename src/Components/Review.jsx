...
const Review = () => {
  return (
    <div>
    <h1 className='text-3xl font-bold text-green-500 text-center'>Why Contribute to Our Blog?</h1>
    <div className='flex justify-evenly items-center max-w-7xl mx-auto gap-3 my-12'>
          ...
          <h1 className='text-2xl font-bold text-orange-900'>Write for Us!</h1>
          <p className='text-[16px] mb-5 font-semibold text-gray-600'>Are you passionate about Technology,Food or News? Do you have insightful thoughts, experiences, or expertise that you want to share with the world? If so, we’d love to feature your content on our blog!</p>

          <h1 className='text-2xl font-bold text-orange-900'>Why Contribute to Our Blog?</h1>
