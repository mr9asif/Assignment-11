...
const Review = () => {
  return (
    ...
    <div className='flex justify-evenly items-center max-w-7xl mx-auto gap-3 my-12'>
          <div>
          ...
          <h1  data-aos="fade-up"
          data-aos-duration="3000" className='text-2xl font-bold text-orange-900'>Write for Us!</h1>
          <p  data-aos="fade-up"
          data-aos-duration="3000" className='text-[16px] mb-5 font-semibold text-gray-600'>Are you passionate about Technology,Food or News? Do you have insightful thoughts, experiences, or expertise that you want to share with the world? If so, we’d love to feature your content on our blog!</p>

          <h1  data-aos="fade-up"
          data-aos-duration="3000" className='text-2xl font-bold text-orange-900'>Why Contribute to Our Blog?</h1>
           <ul  data-aos="fade-up"
           data-aos-duration="3000" className='list-disc pl-6 text-gray-900'>
    ...
    <div  data-aos="fade-up"
    data-aos-duration="3000" className='rounded-md p-2'>
        <video
            src={video1}
