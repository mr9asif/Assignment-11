...
const AllBlogs = () => {
    ...
    return (
        ...
        <h1 className="text-3xl font-bold my-4 text-orange-400 text-center">All Blogs</h1>
          ...
          <div tabIndex={0} role="button" className="btn text-xl font-bold text-gray-500 bg-gray-600 hover:bg-orange-500 m-1">All</div>
          <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
             ...
             <div className="flex justify-center items-center gap-3">
               <input type="text" className='p-2 bg-gray-100 rounded-xl  text-gray-900 font-bold' name="" id="" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
             {
                filterCatagory.map(blog=><Blogs key={blog._id} blog={blog}></Blogs> )
             }
        </div>
    </div>
    );
